...
#define OPERAND_EXT(s) &TranslationTableX86Base::OperandExt<(s)>
	...
	void TranslationTableX86Base::InitOperands(OperandFunc mrm, std::initializer_list<std::initializer_list<OperandFunc>> operands) {
		...
		for (auto itRow = operands.begin(); (operands.end() != itRow) && (i < 2); ++i, ++itRow) {
			...
			for (; j < 0x100; ++j) {
				operandTbl[i][j] = &TranslationTableX86Base::OperandNull;
			}
		}
	...
	extern TranslationTableX86Base tableX86Base(&TranslationTableX86Base::OperandOverride, 
	{ 
		{
			...
			/* 0x98 */ OPCODE_ERROR, OPCODE_DEFAULT, OPCODE_ERROR, OPCODE_ERROR,
			...
			/* 0xD8 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			...
			/* 0x0C */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			...
			/* 0x28 */ OPCODE_DEFAULT, OPCODE_DEFAULT, OPCODE_ERROR, OPCODE_ERROR,
			/* 0x2C */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,

			/* 0x30 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			...
			/* 0x50 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			/* 0x54 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_DEFAULT,
			/* 0x58 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			/* 0x5C */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			...
			/* 0xA0 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			/* 0xA4 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR,
			/* 0xA8 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_DEFAULT,
			/* 0xAC */ OPCODE_DEFAULT, OPCODE_ERROR, OPCODE_ERROR, OPCODE_DEFAULT,
			...
			/* 0xD4 */ OPCODE_ERROR, OPCODE_ERROR, OPCODE_ERROR, OPCODE_DEFAULT,
	...
	}, { 
		{
			...
			/* 0x98 */ OPERAND_ERROR, OPERAND_NONE, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0xA8 */ OPERAND_IMM8, OPERAND_IMM1632, OPERAND_MODRM, OPERAND_NONE,
			...
			/* 0xD8 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0x0C */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0x1C */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,

			/* 0x20 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x24 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x28 */ OPERAND_MODRM, OPERAND_MODRM, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x2C */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,

			/* 0x30 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x34 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0x50 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x54 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_MODRM,
			/* 0x58 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0x5C */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0xA0 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			/* 0xA4 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR,
			...
			/* 0xD4 */ OPERAND_ERROR, OPERAND_ERROR, OPERAND_ERROR, OPERAND_MODRM,
